#!/usr/bin/env python3
"""
Recuperation des codes promo Ninja Kitchen depuis shopilo.fr
Sursa: https://shopilo.fr/reductions/ninjakitchen.fr
"""
...
SHOPILO_URL = "https://shopilo.fr/reductions/ninjakitchen.fr"
STORE_NAME = "Ninja Kitchen"


def fetch_coupons(url=SHOPILO_URL):
    """Renvoie la liste des coupons actifs pour Ninja Kitchen depuis shopilo.fr"""
    headers = {
        "User-Agent": "Mozilla/5.0 (compatible; coupon-fetcher/1.0; +https://github.com/shopilo-fr/code-promo-ninjakitchen)"
    }
    try:
